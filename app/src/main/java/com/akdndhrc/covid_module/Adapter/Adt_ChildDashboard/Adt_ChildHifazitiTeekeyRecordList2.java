...
public class Adt_ChildHifazitiTeekeyRecordList2 extends BaseAdapter {
    private Context ctx;
    ...
    // Constructor
    public Adt_ChildHifazitiTeekeyRecordList2(Context ctx, ArrayList<String> arrayListVaccine, ArrayList<String> arrayListDate) {
        this.ctx = ctx;
