...
public class Adt_ChildHifazitiTeekeyRecordList_DueDate extends BaseAdapter {
    private Context ctx;
    ...
    // Constructor
    public Adt_ChildHifazitiTeekeyRecordList_DueDate(Context ctx, ArrayList<String> arrayListVaccine, ArrayList<String> arrayListDate) {
        this.ctx = ctx;
