package com.akdndhrc.covid_module.Adapter.Adt_CovidImmunization;
...
public class Adt_ComorbidityRecordList extends BaseAdapter {
    private Context ctx;
    ...
    // Constructor
    public Adt_ComorbidityRecordList(Context ctx, ArrayList<HashMap<String, String>> hashMapArrayList) {
        this.ctx = ctx;
    ...
    public View getView(final int pos, View row, ViewGroup viewGroup) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_lv_cormorbidity_record_list_layout, null);
