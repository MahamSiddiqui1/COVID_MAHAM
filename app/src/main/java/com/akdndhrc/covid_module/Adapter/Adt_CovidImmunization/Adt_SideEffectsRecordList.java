...
public class Adt_SideEffectsRecordList extends BaseAdapter {
    private Context ctx;
    ...
    // Constructor
    public Adt_SideEffectsRecordList(Context ctx, ArrayList<HashMap<String, String>> hashMapArrayList) {
        this.ctx = ctx;
    ...
    public View getView(final int pos, View row, ViewGroup viewGroup) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.custom_lv_side_effects_record_list_layout, null);
