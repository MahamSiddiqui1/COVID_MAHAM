...
public class Adt_VACExpandableList extends BaseExpandableListAdapter {
    ...
    public Adt_VACExpandableList(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
      ...
      /*  if (groupPosition==0) {
            ...
            holder.hp_lv_tvNaam.setTextColor(_context.getResources().getColor(R.color.graph_red_color));
            holder.hp_lv_tvNaam.setTypeface(Typeface.DEFAULT);
        }*/


                holder.hp_lv_tvNaam.setTextColor(_context.getResources().getColor(R.color.uvv_black));
                holder.hp_lv_tvNaam.setTypeface(Typeface.DEFAULT_BOLD);
