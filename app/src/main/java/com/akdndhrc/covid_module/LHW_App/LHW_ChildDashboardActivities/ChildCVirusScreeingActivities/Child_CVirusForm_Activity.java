...
public class Child_CVirusForm_Activity extends AppCompatActivity {

    Context ctx = Child_CVirusForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Child_CVirusForm_Activity.class));
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (serviceLocation.showCurrentLocation() == true) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(mData[0][2]) > 0) {
                            ...
                            Toast.makeText(ctx, R.string.noGPSdata, Toast.LENGTH_SHORT).show();
                        }
                ...
                try {
                    if (spRefHealthFacility.getSelectedItem().toString().equalsIgnoreCase("Others")) {
                        if (et_refferal_hospital_others.getText().toString().isEmpty()) {
                            Toast.makeText(getApplicationContext(), R.string.enterHealthCenterReferalPrompt, Toast.LENGTH_LONG).show();
                            return;
                        }
                    } else {
                ...
                try {
                    ...
                    Lister ls = new Lister(Child_CVirusForm_Activity.this);
                    ls.createAndOpenDB();
                    ...
                    if (res.toString().equalsIgnoreCase("true")) {
                        ...
                        if (Utils.haveNetworkConnection(ctx) > 0) {
                            sendPostRequest(child_uid, et_tareekh_indraj.getText().toString(), "0", String.valueOf(jobj), login_useruid, cur_added_on);
                        } else {
                        ...
                        final Snackbar snackbar = Snackbar.make(v, R.string.noDataSyncAlert, Snackbar.LENGTH_SHORT);
                        View mySbView = snackbar.getView();
                        mySbView.setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
                        mySbView.setBackgroundColor(ctx.getResources().getColor(android.R.color.black));
                        TextView textView = mySbView.findViewById(android.support.design.R.id.snackbar_text);
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        String update_record = "UPDATE CVIRUS SET " +
                                ...
                                "WHERE member_uid = '" + child_uid + "'AND record_data= '" + et_tareekh_indraj.getText().toString() + "'AND added_on= '" + added_on + "' AND type IS '0'";
                        ...
                        Toast.makeText(Child_CVirusForm_Activity.this, R.string.noDataSyncServerAlert, Toast.LENGTH_SHORT).show();
                    }
    ...
    public void ReferalFormSubmit() {
        try {
            ...
            Boolean res = ls.executeNonQuery(ans1);
            Log.d("000987", " Ref Data: " + ans1);
            Log.d("000987", "Ref Data: " + res.toString());

            if (Utils.haveNetworkConnection(ctx) > 0) {
                sendPostRequestReferal(child_uid, et_tareekh_indraj.getText().toString(), String.valueOf(jobj), login_useruid, cur_added_on);
            } else {
                //  Toast.makeText(ctx, R.string.dataSubmissionMessage, Toast.LENGTH_SHORT).show();
            }

        } catch (Exception e) {
            Log.d("000987", "Ref Err: " + e.getMessage());
            Toast.makeText(getApplicationContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
        } finally {
    ...
    private void sendPostRequestReferal(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        Log.d("000987", "Ref Response:    " + response);
                    ...
                    Log.d("000987", "ref catch " + e.getMessage());
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000987", "Ref onErrorResponse: " + error.getMessage());
                //  Toast.makeText(Child_BemaariRecordForm_Activity.this, "برائے مہربانی انٹرنیٹ کنکشن چیک کریں", Toast.LENGTH_SHORT).show();
    ...
    public void ShowTareekhIndraajDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Child_CVirusForm_Activity.this, R.style.DatePickerDialog,
