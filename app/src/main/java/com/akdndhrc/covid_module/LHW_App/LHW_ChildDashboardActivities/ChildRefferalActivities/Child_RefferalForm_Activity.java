...
public class Child_RefferalForm_Activity extends AppCompatActivity {

    Context ctx = Child_RefferalForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Child_RefferalForm_Activity.class));
            ...
            public void onClick(View v) {
               ...
               /* if (et_refferal_hospital.getText().toString().isEmpty()) {
                ...
                try {
                    ...
                    Lister ls = new Lister(Child_RefferalForm_Activity.this);
                    ls.createAndOpenDB();
    ...
    public void ShowTareekhIndraajDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Child_RefferalForm_Activity.this, R.style.DatePickerDialog,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    //     Toast.makeText(Child_RefferalForm_Activity.this, "Data has been sent incorrectly.", Toast.LENGTH_SHORT).show();
