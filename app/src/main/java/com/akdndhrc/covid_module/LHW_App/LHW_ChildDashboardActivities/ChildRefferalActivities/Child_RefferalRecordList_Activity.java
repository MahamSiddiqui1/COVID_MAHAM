...
public class Child_RefferalRecordList_Activity extends AppCompatActivity {

    Context ctx = Child_RefferalRecordList_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Child_RefferalRecordList_Activity.class));
    ...
    protected void onResume() {
        ...
        try {
            ...
            Lister ls = new Lister(Child_RefferalRecordList_Activity.this);
          ls.createAndOpenDB();
