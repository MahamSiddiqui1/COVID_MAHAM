...
public class AboveTwoMaleProfile_Activity extends AppCompatActivity {

    Context ctx = AboveTwoMaleProfile_Activity.this;
    ...
    String member_uid, TodayDate, khandan_id, added_on;
    ...
    public static String var_aboveTwo_profile="0";
    int age;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        var_aboveTwo_profile = "0";

        member_uid = getIntent().getExtras().getString("u_id");
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (et_khandan_number.getText().toString().isEmpty()) {
                    final Snackbar snackbar = Snackbar.make(v, "برائے مہربانی خاندان نمبر درج کریں.", Snackbar.LENGTH_SHORT);
                    View mySbView = snackbar.getView();
                    mySbView.setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
                    mySbView.setBackgroundColor(ctx.getResources().getColor(android.R.color.black));
                    TextView textView = (TextView) mySbView.findViewById(android.support.design.R.id.snackbar_text);
                    ...
                    try {
                        ...
                        if (res.toString().equalsIgnoreCase("true"))
                        {
                            ...
                            if (Utils.haveNetworkConnection(ctx) > 0) {
                                ...
                                sendPostRequest(et_infradi.getText().toString(), member_uid, khandan_id, et_naam_bimaah_waldiyat.getText().toString(), et_shanakhti_card_number.getText().toString(),
...
// Sp gender
    ...
    protected void onResume() {
        ...
        try {
            Lister ls = new Lister(ctx);
            ls.createAndOpenDB();
            String mData[][] = ls.executeReader("Select data ,khandan_id,added_on,gender,age,qr_code from MEMBER where uid = '" + member_uid + "'");
