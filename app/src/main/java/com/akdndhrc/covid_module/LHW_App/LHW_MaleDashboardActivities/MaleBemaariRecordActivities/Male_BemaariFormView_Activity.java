...
public class Male_BemaariFormView_Activity extends AppCompatActivity {

    Context ctx = Male_BemaariFormView_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Male_BemaariFormView_Activity.class));
        ...
        try {
            ...
            for (int i = 0; i < x.length; i++) {
                ...
                String update_record = "UPDATE MEDICINE_LOG SET " +
                        ...
                        "WHERE member_uid = '" + male_uid + "'  AND disease = '" + x[i].split("@")[1] + "' AND record_data = '" + record_date + "'";
   ...
   /*     sp_elaaj.setAdapter(
    ...
    protected void onResume() {
        ...
        try {
            ...
            String mData[][] = ls.executeReader("Select data from MBEMARI where member_uid = '" + male_uid + "'  AND added_on = '" + added_on + "' AND record_data = '" + record_date + "'");
            ...
            Log.d("000852", "Data: " + male_uid);

            try {

                String mDataaa[][] = ls.executeReader("Select disease from MEDICINE_LOG where member_uid = '" + male_uid + "' AND added_on = '" + added_on + "'");
