...
public class Male_RefferalFormView_Activity extends AppCompatActivity {

    Context ctx = Male_RefferalFormView_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Male_RefferalFormView_Activity.class));
      ...
      /*  if (et_refferal_hospital.getText().toString().isEmpty()) {
        ...
        try {
            ...
            if (jsonObject.has("lat")) {
                ...
                jsonObject.put("referal_health_facility", "" + spRefHealthFacility.getSelectedItem());
                jsonObject.put("referal_health_facility_pos", "" + String.valueOf(spRefHealthFacility.getSelectedItemPosition() - 1));
    ...
    protected void onResume() {
        ...
        try {
            ...
            if (jsonObject.has("referal_record_date")) {
                ...
                spRefHealthFacility.setSelection(Integer.parseInt(jsonObject.getString("referal_health_facility_pos")) + 1);
