...
public class Mother_BemaariForm_Activity extends AppCompatActivity {

    Context ctx = Mother_BemaariForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_BemaariForm_Activity.class));
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!checkbox_ishaal.isChecked() && !checkbox_khansi_aur_saans.isChecked() && !checkbox_bukhar.isChecked() && !checkbox_khoon_ki_kami.isChecked()
                    ...
                    final Snackbar snackbar = Snackbar.make(v, "برائے مہربانی بیماری کے چیک باکس کو منتخب کریں.", Snackbar.LENGTH_SHORT);
                    View mySbView = snackbar.getView();
                    mySbView.setLayoutDirection(View.LAYOUT_DIRECTION_LTR);
                    mySbView.setBackgroundColor(ctx.getResources().getColor(android.R.color.black));
                    TextView textView = (TextView) mySbView.findViewById(android.support.design.R.id.snackbar_text);
                ...
                try {
                    ...
                    Lister ls = new Lister(Mother_BemaariForm_Activity.this);
                    ls.createAndOpenDB();
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Log.d("000852", "Err: " + e.getMessage());
                    //Toast.makeText(Mother_BemaariForm_Activity.this, "Data has been sent incorrectly.", Toast.LENGTH_SHORT).show();
                    Toast tt  =Toast.makeText(ctx, "ڈیٹا سینک نہیں ہوا", Toast.LENGTH_SHORT);
                    tt.setGravity(Gravity.CENTER, 0, 0);
                    tt.show();
                }
    ...
    public void ReferalFormSubmit() {
        try {
            ...
            jobj.put("referal_reason", "" + et_refferal_ki_waja.getText().toString());
            jobj.put("referal_facility", "" + et_refferal_hospital.getText().toString());//spinner
            jobj.put("referal_type", "" + "MBemari");//spinner
    ...
    public void ShowDateDialougeTareekhIndraaj() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Mother_BemaariForm_Activity.this, R.style.DatePickerDialog,
