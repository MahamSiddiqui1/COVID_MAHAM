...
public class Mother_BemaariRecordList_Activity extends AppCompatActivity {

    Context ctx = Mother_BemaariRecordList_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_bemaari_record_list);

        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_BemaariRecordList_Activity.class));
     ...
     //   iv_home.setVisibility(View.GONE);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent newIntent = new Intent(ctx, Mother_BemaariFormView_Activity.class);
                ...
                try {
                    ...
                    if (Integer.parseInt(mData[0][1]) > 0) {
                        ...
                        if (Integer.parseInt(dayDifference) >= 1 || Integer.parseInt(dayDifference) > 1) {
                            ...
                            Intent intent4 = new Intent(ctx, Mother_BemaariForm_Activity.class);
    ...
    private void prepareListData() {
        ...
        try {
            ...
            Lister ls = new Lister(Mother_BemaariRecordList_Activity.this);
           ls.createAndOpenDB();
            ...
            try {
                ...
                mData = ls.executeReader("Select record_data,added_on from MBEMARI where member_uid = '" + mother_uid + "'  AND date(record_data) BETWEEN '" + et_is_tareekh_sy.getText().toString() + "' AND'" + et_is_tareekh_tk.getText().toString() + "' ORDER BY added_on DESC");
