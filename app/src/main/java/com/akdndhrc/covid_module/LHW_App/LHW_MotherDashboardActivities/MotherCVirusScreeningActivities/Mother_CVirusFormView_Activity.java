...
public class Mother_CVirusFormView_Activity extends AppCompatActivity {

    Context ctx = Mother_CVirusFormView_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_CVirusFormView_Activity.class));
    ...
    private void update_data(final View v) {
        ...
        try {
            ...
            Lister ls = new Lister(Mother_CVirusFormView_Activity.this);
            ls.createAndOpenDB();
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String update_record = "UPDATE CVIRUS SET " +
                                ...
                                "is_synced='" + 0 + "'" +
                                "WHERE member_uid = '" + mother_uid + "'  AND record_data = '" + record_date + "' AND added_on= '" + added_on + "' AND type IS '1'";
    ...
    private void update_referal_data(String cur_added_on) {
        ...
        try {
            ...
            String update_record = "UPDATE REFERAL SET " +
                    ...
                    "is_synced='" + 0 + "'" +
                    "WHERE member_uid = '" + mother_uid + "'  AND record_data = '" + record_date + "' AND added_on= '" + added_on + "' AND JSON_EXTRACT(data, '$.type') IS 'MVirus'";
    ...
    public void ShowTareekhIndraajDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Mother_CVirusFormView_Activity.this, R.style.DatePickerDialog,
    ...
    protected void onResume() {
        ...
        try {
            ...
            String mData[][] = ls.executeReader("Select t0.data,t1.data from CVIRUS t0" +
                    ...
                    " where t0.member_uid = '" + mother_uid + "' AND t0.record_data = '" + record_date + "'  AND t0.added_on ='" + added_on + "' AND t0.type IS '1'");
