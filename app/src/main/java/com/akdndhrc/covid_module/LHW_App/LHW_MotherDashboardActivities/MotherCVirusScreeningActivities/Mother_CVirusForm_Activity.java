...
public class Mother_CVirusForm_Activity extends AppCompatActivity {

    Context ctx = Mother_CVirusForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_virus_form);

        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_CVirusForm_Activity.class));
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Lister ls = new Lister(Mother_CVirusForm_Activity.this);
                    ls.createAndOpenDB();
                    ...
                    if (res.toString().equalsIgnoreCase("true")) {
                        ...
                        if (Utils.haveNetworkConnection(ctx) > 0) {
                            sendPostRequest(mother_uid, et_tareekh_indraj.getText().toString(), "1", String.valueOf(jobj), login_useruid, cur_added_on);
                        } else {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        String update_record = "UPDATE CVIRUS SET " +
                                ...
                                "WHERE member_uid = '" + mother_uid + "'AND record_data= '" + et_tareekh_indraj.getText().toString() + "'AND added_on= '" + added_on + "' AND type IS '1'";
                        ...
                        Toast.makeText(Mother_CVirusForm_Activity.this, R.string.noDataSyncServerAlert, Toast.LENGTH_SHORT).show();
                    }
    ...
    public void ReferalFormSubmit() {
        try {
            ...
            if (Utils.haveNetworkConnection(ctx) > 0) {
                sendPostRequestReferal(mother_uid, et_tareekh_indraj.getText().toString(), String.valueOf(jobj), login_useruid, cur_added_on);
            } else {
                //  Toast.makeText(ctx, R.string.dataSubmissionMessage, Toast.LENGTH_SHORT).show();
            }
    ...
    public void ShowTareekhIndraajDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Mother_CVirusForm_Activity.this, R.style.DatePickerDialog,
