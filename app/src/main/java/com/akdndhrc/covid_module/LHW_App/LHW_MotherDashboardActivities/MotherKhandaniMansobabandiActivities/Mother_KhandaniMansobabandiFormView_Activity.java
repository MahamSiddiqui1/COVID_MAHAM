...
public class Mother_KhandaniMansobabandiFormView_Activity extends AppCompatActivity {

    Context ctx = Mother_KhandaniMansobabandiFormView_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_KhandaniMansobabandiFormView_Activity.class));
        ...
        //et_tariqa = findViewById(R.id.et_tariqa);
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sp_planning_type.setEnabled(true);
                        sp_naya_sabiqa.setEnabled(true);
                        ...
                        checkbox_awareness.setEnabled(true);
                        checkbox_service_provided.setEnabled(true);
                        sp_material.setEnabled(true);
                        rl_add.setEnabled(true);
...
//                ((TextView) parent.getChildAt(0)).setTextColor(Color.GREEN);
    ...
    protected void onResume() {
        ...
        try {
            ...
            sp_planning_type.setSelection(Integer.parseInt(jsonObject.getString("tariqa")) + 1);
            sp_naya_sabiqa.setSelection(Integer.parseInt(jsonObject.getString("plan")) + 1);
