...
public class Mother_KhandaniMansobabandiList_Activity extends AppCompatActivity {

    Context ctx = Mother_KhandaniMansobabandiList_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_khandani_mansobabandi_list);

        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Mother_KhandaniMansobabandiList_Activity.class));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent newIntent = new Intent(ctx, Mother_KhandaniMansobabandiFormView_Activity.class);
        ...
        btn_naya_form_shamil_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Lister ls = new Lister(Mother_KhandaniMansobabandiList_Activity.this);
                    ls.createAndOpenDB();
                    ...
                    if (Integer.parseInt(mData[0][1]) > 0) {
                        ...
                        if (Integer.parseInt(dayDifference) >= 1 || Integer.parseInt(dayDifference) > 1) {
                            Log.d("000985", "IF !!!!!!!!!!!!!!!!!!!!!!!!");
                            Intent intent3 = new Intent(ctx, Mother_KhandaniMansobabandiForm_Activity.class);
