package com.akdndhrc.covid_module.LHW_App.LHW_MotherDashboardActivities;
...
import com.akdndhrc.covid_module.LHW_App.LHW_MotherDashboardActivities.MotherCVirusScreeningActivities.Mother_CVirusRecordList_Activity;
...
public class Mother_Dashboard_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    RelativeLayout rl_haamla_ka_record, rl_khandani_mansobabandi, rl_beemari_ka_record, rl_hifazati_teekey_ka_record, rl_mawaad, rl_refferal, rl_profile, rl_aam_malomaat,rl_virus_screeing;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_virus_screeing:
                ...
                Intent intent7 = new Intent(ctx, Mother_CVirusRecordList_Activity.class);
                intent7.putExtra("u_id", mother_uid);
                intent7.putExtra("mother_name", mother_name);
                intent7.putExtra("mother_age", mother_age);
