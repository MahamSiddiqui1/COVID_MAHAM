...
import com.akdndhrc.covid_module.LHW_App.LHW_NavigationActivities.LHW_SyncDataActivities.SyncImages_Activity;
import com.akdndhrc.covid_module.LHW_App.LHW_NavigationActivities.LHW_SyncDataActivities.SyncItems_Activity;
...
public class ClassListener implements OnClickListener {
    ...
    RelativeLayout rl_bluetooth_share, rl_register, rl_search, rl_vaccinate_inlisted, rl_sync, rl_adaad_O_shumaar, rl_aamdani, rl_refferal, rl_taleeem_O_wasaeel, rl_application_settings, rl_logout, rl_sync_images;
    ImageView image_cancel, iv_Satisfied, iv_VerySatisfied, iv_Neutral, iv_UnSatisfied, iv_VeryUnSatisfied, iv_close, iv_feedback_emoji;
    ...
    public ClassListener(Activity act, SlideMenu slideMenu) {
    ...
    public void init() {
        ...
        //Relative Layout
        rl_register = act.findViewById(R.id.rl_register);
        rl_search = act.findViewById(R.id.rl_search);
        rl_vaccinate_inlisted = act.findViewById(R.id.rl_vaccinate_inlisted);
        rl_sync = act.findViewById(R.id.rl_sync);
        rl_adaad_O_shumaar = act.findViewById(R.id.rl_adaad_O_shumaar);
        rl_aamdani = act.findViewById(R.id.rl_aamdani);
        rl_refferal = act.findViewById(R.id.rl_refferal);
        rl_taleeem_O_wasaeel = act.findViewById(R.id.rl_taleeem_O_wasaeel);
        rl_application_settings = act.findViewById(R.id.rl_application_settings);
        ...
        rl_taleeem_O_wasaeel.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_sync_images:
                act.startActivity(new Intent(act, SyncImages_Activity.class));
                break;
