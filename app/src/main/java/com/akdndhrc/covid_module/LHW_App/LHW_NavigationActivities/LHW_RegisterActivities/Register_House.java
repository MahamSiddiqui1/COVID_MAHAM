...
public class Register_House extends AppCompatActivity {

    Context ctx = Register_House.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Register_House.class));
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(Register_House.this, sp_union_council, tehsils);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(Register_House.this, sp_gaon, tehsils);
...
//                ((TextView) parent.getChildAt(0)).setTextColor(Color.GREEN);
                ...
                try {
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(Register_House.this, sp_tahseel, tehsils);
