...
public class MotherRegister_Activity extends AppCompatActivity {

    Context ctx = MotherRegister_Activity.this;
    ...
    // GPSTracker class
    GPSTracker gps;
    String khandan_uuid_sp, khandan_id, khandan_number;
    ...
    public static  String  temp_search_motherreg="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_register_);

        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, MotherRegister_Activity.class));
...
//                ((TextView) parent.getChildAt(0)).setTextColor(Color.GREEN);
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Lister ls = new Lister(MotherRegister_Activity.this);
                   ls.createAndOpenDB();
    ...
    private void sendPostRequest(final String manual_id, final String uid, final String khandan_id, final String full_name,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        //Toast.makeText(MotherRegister_Activity.this, "Data has not been sent to the service.", Toast.LENGTH_SHORT).show();
                    }

                } catch (Exception e) {
                    Log.d("000555", "Err: " + e.getMessage());
                    //    Toast.makeText(MotherRegister_Activity.this, "Data has been sent incorrectly.", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //Toast.makeText(MotherRegister_Activity.this, "برائے مہربانی انٹرنیٹ کنکشن چیک کریں", Toast.LENGTH_SHORT).show();
                Toast tt  =Toast.makeText(ctx, "ڈیٹا سینک نہیں ہوا", Toast.LENGTH_SHORT);
                tt.setGravity(Gravity.CENTER, 0, 0);
                tt.show();
    ...
    public void ShowTareekhPedaishDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(MotherRegister_Activity.this, R.style.DatePickerDialog,
