...
public class HCM_RegisterForm_Activity extends AppCompatActivity {

    Context ctx = HCM_RegisterForm_Activity.this;

    ImageView iv_home;

    EditText et_name, et_age, et_mobile_number, et_expertise, et_address;
    Spinner sp_gender;
    ...
    public static String var_hcm_register = "0";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hcm_register_form);
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    jobj.put("full_name", "" + et_name.getText().toString());
                    jobj.put("age", "" + et_age.getText().toString());
                    jobj.put("gender", "" + String.valueOf(sp_gender.getSelectedItemPosition() - 1));
                    jobj.put("mobile_number", "" + et_mobile_number.getText().toString());
                    jobj.put("address", "" + et_address.getText().toString());
                    jobj.put("expertise", "" + et_expertise.getText().toString());
                    ...
                    if (Utils.haveNetworkConnection(ctx) > 0) {
                        ...
                        Toast.makeText(ctx, "رکن  رجسٹر ہوگیا ہے", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Intent intent = new Intent(ctx, HCM_MemberList_Activity.class);
