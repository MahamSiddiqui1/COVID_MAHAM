...
import com.akdndhrc.covid_module.Adapter.Adt_SocialContact.Adt_HESchoolList;
...
public class HES_SchoolList_Activity extends AppCompatActivity {


    Context ctx = HES_SchoolList_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hes_school_list);
        ...
        btn_FabRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newIntent = new Intent(ctx, HES_RegisterSchoolForm_Activity.class);
        ...
        iv_startMeeting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newIntent = new Intent(ctx, HES_StartSchoolMeetingList_Activity.class);
    ...
    protected void onResume() {
        ...
        try {
            ...
            //String[][] mData = ls.executeReader("Select JSON_EXTRACT(metadata, '$.school_name'),JSON_EXTRACT(metadata, '$.school_headname') from MEETING_MEMBER where meeting_uid = '" + meeting_uid + "' AND type='"+type+"'");
            String[][] mData = ls.executeReader("Select JSON_EXTRACT(metadata, '$.school_name'),JSON_EXTRACT(metadata, '$.school_headname') from MEETING_MEMBER where  type='"+type+"'");
            ...
            if (mData != null) {
                ...
                for (int i = 0; i < mData.length; i++) {
                    ...
                    Log.d("000357", "SCHOOL NAME: " +  mData[i][0]);
                    Log.d("000357", "SCHOOL HEAD NAME " +  mData[i][1]);
