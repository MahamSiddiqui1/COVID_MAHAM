...
public class SyncChildAamMalomat_Activity extends AppCompatActivity {

    Context ctx = SyncChildAamMalomat_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncChildGenInfo);
        ...
        try {
            ...
            Log.d("000106", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000106", "Shared Err:" + e.getMessage());
        }
      ...
      /* adt = new Adt_SyncItems(ctx, arrayList);
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000106", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000106", "IFFFF OFFLINE");
                    } else {
                        Log.d("000106", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000106", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000106", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000106", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000106", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000106", "onErrorResponse: " + error.getMessage());
                
                String string = new String(error.networkResponse.data);
                Log.d("000106", "onErrorResponse String: " + string);
                Log.d("000106", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000106", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000106", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
           ...
           jobj.put("added_on", added_on);
            ...
            switch (simState) {
                ...
                case TelephonyManager.SIM_STATE_READY:
                    ...
                    PendingIntent piSent = PendingIntent.getBroadcast(SyncChildAamMalomat_Activity.this, 0, new Intent("SMS_SENT"), 0);
                    PendingIntent piDelivered = PendingIntent.getBroadcast(SyncChildAamMalomat_Activity.this, 0, new Intent("SMS_DELIVERED"), 0);
   ...
   /* @Override
    protected void onResume() {
        ...
        try {
           ...
           ls.createAndOpenDB();
            ...
            mData = ls.executeReader("Select *from CMALOOM where is_synced = '0'");
            Log.d("000106", "Data: " + mData.length);

            HashMap<String, String> map;
            for (int i = 0; i < mData.length; i++) {

                map = new HashMap<>();
                Log.d("000106", "ID: " + mData[i][0]);
                Log.d("000106", "member_uid: " + mData[i][1]);
                Log.d("000106", "record_data: " + mData[i][2]);
                Log.d("000106", "data: " + mData[i][3]);
                Log.d("000106", "added_by: " + mData[i][4]);
                Log.d("000106", "is_synced: " + mData[i][5]);
                Log.d("000106", "added_on: " + mData[i][6]);
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000106", "Child Name: " + mData_name[j][0]);
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000106", "datetime: " + formatted);
    ...
    public void read_data(){
        ...
        try {
            ...
            mData = ls.executeReader("Select *from CMALOOM where  is_synced IN ('0','0,3')");
            Log.d("000106", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
              ...
              /*  Log.d("000106", "data: " + mData[i][3]);
                ...
                if (mData_name != null) {
                    Log.d("000106", "IF ***********: ");
                    Log.d("000106", "Child Name: " + mData_name[0][0]);
                    Log.d("000106", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000106", "ELSEEEEEE +++++++++++++: ");
