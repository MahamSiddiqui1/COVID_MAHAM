...
public class SyncChildBemari_Activity extends AppCompatActivity {

    Context ctx = SyncChildBemari_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       TextView tv = findViewById(R.id.tv);
        tv.setText(R.string.syncChildDisease);
        ...
        try {
            ...
            Log.d("000104", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000104", "Shared Err:" + e.getMessage());
        }
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000104", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000104", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000104", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000104", "onResume Error: " +e.getMessage());
       ...
       // String url = "https://pak.api.teekoplus.akdndhrc.org/sync/save/child/illness";
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000104", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000104", "onErrorResponse: " + error.getMessage());
   ...
   private void sendPostRequest_Overall(final String member_uid, final String record_data,
                                 final String data, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            Log.d("000104", "JSON DATA:  " + jobj.toString());
            ...
            switch (simState) {
                ...
                case TelephonyManager.SIM_STATE_READY:
                    ...
                    PendingIntent piSent = PendingIntent.getBroadcast(SyncChildBemari_Activity.this, 0, new Intent("SMS_SENT"), 0);
                    PendingIntent piDelivered = PendingIntent.getBroadcast(SyncChildBemari_Activity.this, 0, new Intent("SMS_DELIVERED"), 0);
                    ...
                    try {
                        ...
                        Log.d("000104", "SMS SENT SUCCESSFULLY !!!!!!!!!!");
                        ...
                        Log.d("000104", "Data Update:  " + update_record);
                        Log.d("000104", "Query Update:  " + res);
                        ...
                        progressDialog.dismiss();
                        Log.d("000104", "Exception Sending faild " + e);
                        e.printStackTrace();
            ...
            Log.e("000104", "Error:: " + e.getMessage());
        }
    }
    ...
    public static String getBase64String(String jsonString) {
        ...
        try {
            ...
            Log.e("000104", "Exception: " + e.getMessage());
        }
        //Log.d("000104", "getBase64String " + base64);
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from CBEMARI where is_synced IN ('0','0,3')");
            Log.d("000104", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                Log.d("000104", "ID: " + mData[i][0]);
                Log.d("000104", "member_uid: " + mData[i][1]);
                Log.d("000104", "record_data: " + mData[i][2]);
                Log.d("000104", "data: " + mData[i][3]);
                Log.d("000104", "added_by: " + mData[i][4]);
                Log.d("000104", "is_synced: " + mData[i][5]);
                Log.d("000104", "added_on: " + mData[i][6]);
                ...
                if (mData_name != null) {
                    Log.d("000104", "IF ***********: ");
                    Log.d("000104", "Child Name: " + mData_name[0][0]);
                    Log.d("000104", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000104", "ELSEEEEEE +++++++++++++: ");
               ...
               /* String mData_name[][] = ls.executeReader("Select full_name from MEMBER where uid = '" + mData[i][1] + "'");
                if (mData_name != null)
                {
                    ...
                    if (mData_deleted_name != null) {
                            Log.d("000104", "ELSEEEE Child Name: " + mData_deleted_name[0][0]);
...
*/
                if (mData[i][6] == null) {
                    ...
                    Log.d("000104", "datetime: " + formatted);
    ...
    protected void onResume() {
        ...
        try {
           ...
           ls.createAndOpenDB();
            ...
            mData = ls.executeReader("Select *from CBEMARI where is_synced = '0'");
            Log.d("000104", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000104", "Child Name: " + mData_name[j][0]);
