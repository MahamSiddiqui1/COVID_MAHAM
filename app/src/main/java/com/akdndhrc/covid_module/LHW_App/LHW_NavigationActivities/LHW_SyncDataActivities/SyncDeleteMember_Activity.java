...
public class SyncDeleteMember_Activity extends AppCompatActivity {

    Context ctx = SyncDeleteMember_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncDelMem);
        ...
        iv_sync.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    Toast.makeText(ctx, R.string.workingUnderProgress, Toast.LENGTH_SHORT).show();
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("medicine_id"), arrayList.get(0).get("added_on"), arrayList.get(0).get("added_by"),  arrayList.get(0).get("balance"),
                                            arrayList.get(0).get("utilized"), arrayList.get(0).get("received"), arrayList.get(0).get("wastage"), arrayList.get(0).get("record_data"));
                    ...
                    /*try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequest(arrayList.get(position).get("medicine_id"), arrayList.get(position).get("added_on"), arrayList.get(position).get("added_by"),  arrayList.get(position).get("balance"),
                                        arrayList.get(position).get("utilized"), arrayList.get(position).get("received"), arrayList.get(position).get("wastage"), arrayList.get(position).get("record_data"));
    ...
    private void sendPostRequest(final String medicine_id, final String added_on, final String added_by , final String balance ,final String utilized,  final String received, final String wastage, final String record_data) {

        String url = "https://development.api.teekoplus.akdndhrc.org/sync/save/medicine/stock";
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                       ...
                       ls.createAndOpenDB();
                        ...
                        String update_record = "UPDATE MEDICINE_STOCK SET " +
                                "is_synced='" + String.valueOf(1) + "' " +
                                "WHERE medicine_id = '" + medicine_id + "' AND added_on= '" + added_on + "'AND added_by= '" + added_by + "'";
    ...
    private void sendPostRequest_Overall(final String medicine_id, final String added_on, final String added_by , final String balance ,final String utilized,  final String received, final String wastage, final String record_data){
    ...
    public void sendSMSMethod(final Integer position)
    {
        ...
        try {
            ...
            jobj.put("Id", "" + arrayList.get(position).get("Id"));
            jobj.put("manual_id", "" + arrayList.get(position).get("manual_id"));
            jobj.put("uid", "" + arrayList.get(position).get("uid"));
            jobj.put("khandan_id", "" + arrayList.get(position).get("khandan_id"));
            jobj.put("name", "" + arrayList.get(position).get("name"));
            jobj.put("nicnumber", "" +arrayList.get(position).get("nicnumber"));
            jobj.put("phone_number", "" + arrayList.get(position).get("phone_number"));
            jobj.put("data", "" + arrayList.get(position).get("data"));
            jobj.put("gender", "" + arrayList.get(position).get("gender"));
            jobj.put("age", "" + arrayList.get(position).get("age"));
            jobj.put("dob", "" + arrayList.get(position).get("dob"));
            jobj.put("bio_code", "" + arrayList.get(position).get("bio_code"));
            jobj.put("qr_code", "" + arrayList.get(position).get("qr_code"));
            jobj.put("added_by", "" + arrayList.get(position).get("added_by"));
            jobj.put("is_synced", "" + arrayList.get(position).get("is_synced"));
            jobj.put("added_on", "" + arrayList.get(position).get("added_on"));
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "DELETE_MEMBER" + "|" + toencode_sms;
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                String update_record = "UPDATE DELETE_MEMBER SET " +
                                        ...
                                        "WHERE uid = '" + arrayList.get(position).get("uid") + "' AND added_on= '" + arrayList.get(position).get("added_on") + "'";
    ...
    public void sendSMSMethod_overall()  {

        try {

            JSONObject jobj = new JSONObject();
            jobj.put("Id", "" + arrayList.get(0).get("Id"));
            jobj.put("manual_id", "" + arrayList.get(0).get("manual_id"));
            jobj.put("uid", "" + arrayList.get(0).get("uid"));
            jobj.put("khandan_id", "" + arrayList.get(0).get("khandan_id"));
            jobj.put("name", "" + arrayList.get(0).get("name"));
            jobj.put("nicnumber", "" +arrayList.get(0).get("nicnumber"));
            jobj.put("phone_number", "" + arrayList.get(0).get("phone_number"));
            jobj.put("data", "" + arrayList.get(0).get("data"));
            jobj.put("gender", "" + arrayList.get(0).get("gender"));
            jobj.put("age", "" + arrayList.get(0).get("age"));
            jobj.put("dob", "" + arrayList.get(0).get("dob"));
            jobj.put("bio_code", "" + arrayList.get(0).get("bio_code"));
            jobj.put("qr_code", "" + arrayList.get(0).get("qr_code"));
            jobj.put("added_by", "" + arrayList.get(0).get("added_by"));
            jobj.put("is_synced", "" + arrayList.get(0).get("is_synced"));
            jobj.put("added_on", "" + arrayList.get(0).get("added_on"));
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                String update_record = "UPDATE DELETE_MEMBER SET " +
                                        "is_synced='" + String.valueOf(is_synced) + "' " +
                                        "WHERE uid = '" + arrayList.get(0).get("uid") + "' AND added_on= '" + arrayList.get(0).get("added_on") + "'";
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from DELETE_MEMBER where is_synced IN ('0','0,3')");
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                if (mData[i][15] == null) {
                    ...
                    Log.d("000555", "datetime: " + formatted);
