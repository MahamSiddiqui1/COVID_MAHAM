...
public class SyncMedicineStock_Activity extends AppCompatActivity {

    Context ctx = SyncMedicineStock_Activity.this;
    ListView lv;
                ...
                if (isConnectingToInternet()) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendSMSMethod_overall(arrayList.get(0).get("medicine_id"), arrayList.get(0).get("added_on"), arrayList.get(0).get("added_by"),  arrayList.get(0).get("balance"),
                                    arrayList.get(0).get("utilized"), arrayList.get(0).get("received"), arrayList.get(0).get("wastage"), arrayList.get(0).get("record_data"));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    pos_value = String.valueOf(position);
                    sendSMSMethod(arrayList.get(position).get("medicine_id"), arrayList.get(position).get("added_on"), arrayList.get(position).get("added_by"),  arrayList.get(position).get("balance"),
                            arrayList.get(position).get("utilized"), arrayList.get(position).get("received"), arrayList.get(position).get("wastage"), arrayList.get(position).get("record_data"));
    ...
    public void sendSMSMethod(final String medicine_id, final String added_on, final String added_by , final String balance ,final String utilized,  final String received, final String wastage, final String record_data)
    {

        try {

            JSONObject jobj = new JSONObject();
            jobj.put("uid", medicine_id);
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MED_STOCK" + "|" + toencode_sms;
    ...
    public void sendSMSMethod_overall(final String medicine_id, final String added_on, final String added_by , final String balance ,final String utilized,  final String received, final String wastage, final String record_data)  {
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MEDICINE_STOCK where is_synced IN ('0','0,3')");
