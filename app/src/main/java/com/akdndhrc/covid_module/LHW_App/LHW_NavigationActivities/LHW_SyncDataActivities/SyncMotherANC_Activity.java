...
public class SyncMotherANC_Activity extends AppCompatActivity {

    Context ctx = SyncMotherANC_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncBeforeDelivery);
        ...
        try {
            ...
            Log.d("000113", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000113", "Shared Err:" + e.getMessage());
        }
       ...
       /* adt = new Adt_SyncItems(ctx, arrayList);
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000113", "IFFFF 2");
                    } else {
                        Log.d("000113", "ELssssss 2");
                    }
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000113", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000113", "IFFFF OFFLINE");
                    } else {
                        Log.d("000113", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000113", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000113", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000113", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String pregnancy_id, final String record_data, final String type,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000113", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000113", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000113", "onErrorResponse String: " + string);
                Log.d("000113", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000113", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000113", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String member_uid, final String pregnancy_id, final String record_data, final String type,
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MANC" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MANC where is_synced IN ('0','0,3')");
            Log.d("000113", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
               ...
               // Log.d("000113", "ID: " + mData[i][0]);
                Log.d("000113", "member_uid: " + mData[i][1]);
                Log.d("000113", "pregnancy_id: " + mData[i][2]);
                Log.d("000113", "record_data: " + mData[i][3]);
                Log.d("000113", "type: " + mData[i][4]);
               /* Log.d("000113", "data: " + mData[i][5]);
                Log.d("000113", "added_by: " + mData[i][6]);
                Log.d("000113", "is_synced: " + mData[i][7]);
                Log.d("000113", "added_on: " + mData[i][8]);*/
                ...
                if (mData_name != null) {
                    Log.d("000113", "IF ***********: ");
                    Log.d("000113", "Mother Name: " + mData_name[0][0]);
                    Log.d("000113", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000113", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][8] == null) {
                    ...
                    Log.d("000113", "datetime: " + formatted);
    ...
    protected void onResume() {
        ...
        try {
           ...
           ls.createAndOpenDB();
            ...
            mData = ls.executeReader("Select *from MANC where is_synced = '0'");
            Log.d("000113", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000113", "Child Name" + mData_name[j][0]);
