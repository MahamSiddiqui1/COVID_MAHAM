...
public class SyncMotherBemari_Activity extends AppCompatActivity {

    Context ctx = SyncMotherBemari_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncDisease);
        ...
        try {
            ...
            Log.d("000109", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000109", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000109", "IFFFF 2");
                    } else {
                        Log.d("000109", "ELssssss 2");
                    }
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000109", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000109", "IFFFF OFFLINE");
                    } else {
                        Log.d("000109", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000109", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000109", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000109", "onResume Error: " +e.getMessage());
       ...
       // String url = "https://pak.api.teekoplus.akdndhrc.org/sync/save/mother/illness";
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000109", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000109", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000109", "onErrorResponse String: " + string);
                Log.d("000109", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000109", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000109", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MBEMARI" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MBEMARI where is_synced IN ('0','0,3')");
            Log.d("000109", "Data: " + mData.length);

            HashMap<String, String> map;
            for (int i = 0; i < mData.length; i++) {

                map = new HashMap<>();
              //  Log.d("000109", "ID: " + mData[i][0]);
                Log.d("000109", "member_uid: " + mData[i][1]);
                Log.d("000109", "record_data: " + mData[i][2]);
              /*  Log.d("000109", "data: " + mData[i][3]);
                Log.d("000109", "added_by: " + mData[i][4]);
                Log.d("000109", "is_synced: " + mData[i][5]);
                Log.d("000109", "added_on: " + mData[i][6]);*/
                ...
                if (mData_name != null) {
                    Log.d("000109", "IF ***********: ");
                    Log.d("000109", "Mother Name: " + mData_name[0][0]);
                    Log.d("000109", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000109", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000109", "datetime: " + formatted);
   ...
   /* @Override
    protected void onResume() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MBEMARI where is_synced = '0'");
            Log.d("000109", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000109", "Child Name: " + mData_name[j][0]);
