...
public class SyncMotherDelivery_Activity extends AppCompatActivity {

    Context ctx = SyncMotherDelivery_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncDelivery);
        ...
        try {
            ...
            Log.d("000114", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000114", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000114", "IFFFF 2");
                    } else {
                        Log.d("000114", "ELssssss 2");
                    }
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("pregnancy_id"), arrayList.get(0).get("record_data"),
                                            arrayList.get(0).get("data"), arrayList.get(0).get("type"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000114", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000114", "IFFFF OFFLINE");
                    } else {
                        Log.d("000114", "ELssssss OFFLINE");
                    }
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendSMSMethod_overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("pregnancy_id"), arrayList.get(0).get("record_data"),
                                    arrayList.get(0).get("data"), arrayList.get(0).get("type"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                        }
                    }, 1500);
                }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000114", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                             ...
                             //   sendPostRequest(mData[position][1], mData[position][2], mData[position][3], mData[position][5], mData[position][4], mData[position][6], mData[position][8]);
                                sendPostRequest(arrayList.get(position).get("member_uid"), arrayList.get(position).get("pregnancy_id"), arrayList.get(position).get("record_data"),
                                        arrayList.get(position).get("data"), arrayList.get(position).get("type"), arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
                        ...
                        Log.d("000114", "Catach Err: " + e.getMessage());
                    }
                    ...
                    sendSMSMethod(arrayList.get(position).get("member_uid"), arrayList.get(position).get("pregnancy_id"), arrayList.get(position).get("record_data"),
                            arrayList.get(position).get("data"), arrayList.get(position).get("type"), arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000114", "onResume Error: " +e.getMessage());

        }
    }
    
    private void sendPostRequest(final String member_uid, final String pregnancy_id, final String record_data,   final String data,
                                 final String type, final String added_by, final String added_on) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000114", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000114", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000114", "onErrorResponse String: " + string);
                Log.d("000114", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains(getString(R.string.duplicateEntry)))
                {
                    Log.d("000114", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000114", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String member_uid, final String pregnancy_id, final String record_data,   final String data,
                                         final String type, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String member_uid, final String pregnancy_id, final String record_data, final String data,
                              final String type, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HayatPK" + "|" + uuid + "|" + "MDELIV" + "|" + toencode_sms;
    ...
    public void sendSMSMethod_overall(final String member_uid, final String pregnancy_id, final String record_data, final String data,
                                      final String type, final String added_by, final String added_on)  {
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MDELIV where is_synced IN ('0','0,3')");
            Log.d("000114", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                //Log.d("000114", "ID: " + mData[i][0]);
                Log.d("000114", "member_uid: " + mData[i][1]);
                Log.d("000114", "pregnancy_id: " + mData[i][2]);
                Log.d("000114", "record_data: " + mData[i][3]);
                Log.d("000114", "type: " + mData[i][5]);
               /* Log.d("000114", "data: " + mData[i][4]);
                Log.d("000114", "added_by: " + mData[i][6]);
                Log.d("000114", "is_synced: " + mData[i][7]);
                Log.d("000114", "added_on: " + mData[i][8]);*/
                ...
                map.put("type", "" + mData[i][5]);
                map.put("added_by", "" + mData[i][6]);
                map.put("is_synced", "" + mData[i][7]);
                map.put("added_on", "" + mData[i][8]);
                ...
                if (mData_name != null) {
                    Log.d("000114", "IF ***********: ");
                    Log.d("000114", "Mother Name: " + mData_name[0][0]);
                    Log.d("000114", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000114", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][8] == null) {
                    ...
                    Date date = new Date(Long.parseLong(mData[i][8]));
                    SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy hh:mm:ss");
                    String formatted = format.format(date);
                    Log.d("000114", "datetime: " + formatted);
    ...
    protected void onResume() {
        ...
        try {
           ...
           ls.createAndOpenDB();
            ...
            mData = ls.executeReader("Select *from MDELIV where is_synced = '0'");
            Log.d("000114", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000114", "Child Name: " + mData_name[j][0]);
