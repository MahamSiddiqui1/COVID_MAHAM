...
public class SyncMotherFamilyPlanning_Activity extends AppCompatActivity {

    Context ctx = SyncMotherFamilyPlanning_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("سینک خاندانی منصوبہ بندی");
        ...
        try {
            ...
            Log.d("000110", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000110", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000110", "IFFFF 2");
                    } else {
                        Log.d("000110", "ELssssss 2");
                    }
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000110", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000110", "IFFFF OFFLINE");
                    } else {
                        Log.d("000110", "ELssssss OFFLINE");
                    }

                    //  Toast.makeText(ctx, "برائے مہربانی انٹرنیٹ کنکشن چیک کریں", Toast.LENGTH_SHORT).show();
                    sendSMSMethod_overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("record_data"), arrayList.get(0).get("data"),
                            arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000110", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                               ...
                               // sendPostRequest(mData[position][1], mData[position][2], mData[position][3], mData[position][4], mData[position][6]);
                                sendPostRequest(arrayList.get(position).get("member_uid"), arrayList.get(position).get("record_data"), arrayList.get(position).get("data"),
                        ...
                        Log.d("000110", "Catach Err: " + e.getMessage());
                    }
                    ...
                    pos_value = String.valueOf(position);
                    sendSMSMethod(arrayList.get(position).get("member_uid"), arrayList.get(position).get("record_data"), arrayList.get(position).get("data"),
                            arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000110", "onResume Error: " +e.getMessage());
       ...
       // String url = " https://pak.api.teekoplus.akdndhrc.org/sync/save/mother/family-plan";
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000110", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000110", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000110", "onErrorResponse String: " + string);
                Log.d("000110", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains("Duplicate entry"))
                {
                    Log.d("000110", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000110", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MFPLAN" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MFPLAN where  is_synced IN ('0','0,3')");
            Log.d("000110", "Data: " + mData.length);

            HashMap<String, String> map;
            for (int i = 0; i < mData.length; i++) {

                map = new HashMap<>();
              //  Log.d("000110", "ID: " + mData[i][0]);
                Log.d("000110", "member_uid: " + mData[i][1]);
                Log.d("000110", "record_data: " + mData[i][2]);
              /*  Log.d("000110", "data: " + mData[i][3]);
                Log.d("000110", "added_by: " + mData[i][4]);
                Log.d("000110", "is_synced: " + mData[i][5]);
                Log.d("000110", "added_on: " + mData[i][6]);*/
                ...
                if (mData_name != null) {
                    Log.d("000110", "IF ***********: ");
                    Log.d("000110", "Mother Name: " + mData_name[0][0]);
                    Log.d("000110", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000110", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000110", "datetime: " + formatted);
 ...
 /*   @Override
    protected void onResume() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MFPLAN where is_synced = '0'");
            Log.d("000110", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000110", "Child Name: " + mData_name[j][0]);
