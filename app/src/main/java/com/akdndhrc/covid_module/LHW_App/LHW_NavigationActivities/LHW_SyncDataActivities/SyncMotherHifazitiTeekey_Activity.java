...
public class SyncMotherHifazitiTeekey_Activity extends AppCompatActivity {

    Context ctx = SyncMotherHifazitiTeekey_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000111", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000111", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000111", "IFFFF 2");
                    } else {
                        Log.d("000111", "ELssssss 2");
                    }
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000111", "IFFFF OFFLINE");
                    } else {
                        Log.d("000111", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000111", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000111", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000111", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String vacine_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        Log.d("000111", "response:  " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000111", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000111", "onErrorResponse String: " + string);
                Log.d("000111", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains("Duplicate entry"))
                {
                    Log.d("000111", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000111", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String member_uid, final String vacine_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MVACCINE" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            Log.d("000111", "Data: " + mData.length);

            HashMap<String, String> map;
            for (int i = 0; i < mData.length; i++) {

                map = new HashMap<>();
                //Log.d("000111", "Id: " + mData[i][0]);
                Log.d("000111", "member_uid: "  + mData[i][1]);
                Log.d("000111", "record_data: "+ mData[i][2]);
               /* Log.d("000111", "data:" + mData[i][3]);
                Log.d("000111", "added_by:"+ mData[i][4]);
                Log.d("000111", "is_synced:" + mData[i][5]);
                Log.d("000111", "added_on:" + mData[i][6]);*/
                Log.d("000111", "vaccine_id:" + mData[i][7]);
                Log.d("000111", "type:"+ mData[i][8]);
               // Log.d("000111", "vaccinated_on:"+ mData[i][9]);
                //Log.d("000111", "image_location:" + mData[i][10]);
                ...
                if (mData_name != null) {
                    Log.d("000111", "IF ***********: ");
                    Log.d("000111", "Mother Name: " + mData_name[0][0]);
                    Log.d("000111", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000111", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000111", "datetime: " + formatted);
           ...
           ls.createAndOpenDB();
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000111", "Mother Name: " + mData_name[j][0]);
