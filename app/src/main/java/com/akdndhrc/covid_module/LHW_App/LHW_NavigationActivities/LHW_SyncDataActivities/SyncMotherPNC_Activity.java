...
public class SyncMotherPNC_Activity extends AppCompatActivity {

    Context ctx = SyncMotherPNC_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncAfterDelivery);
        ...
        try {
            ...
            Log.d("000115", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000115", "Shared Err:" + e.getMessage());
        }
       ...
       /* adt = new Adt_SyncItems(ctx, arrayList);
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("pregnancy_id"), arrayList.get(0).get("record_data"),
                                            arrayList.get(0).get("type"), arrayList.get(0).get("data"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000115", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000115", "IFFFF OFFLINE");
                    } else {
                        Log.d("000115", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000115", " mLastClickTime: " + mLastClickTime);
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequest(arrayList.get(position).get("member_uid"), arrayList.get(position).get("pregnancy_id"), arrayList.get(position).get("record_data"),
                                        arrayList.get(position).get("type"), arrayList.get(position).get("data"), arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));

                            }
                        }, 1000);

                    } catch (Exception e) {
                        Log.d("000115", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000115", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String pregnancy_id, final String record_data, final String type,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000115", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000115", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000115", "onErrorResponse String: " + string);
                Log.d("000115", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000115", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000115", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String member_uid, final String pregnancy_id, final String record_data, final String type,
                                         final String data, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String member_uid, final String pregnancy_id, final String record_data, final String type,
                              final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MPNC" + "|" + toencode_sms;
    ...
    public void sendSMSMethod_overall(final String member_uid, final String pregnancy_id, final String record_data, final String type,
                                      final String data, final String added_by, final String added_on)  {
    ...
    private void read_data() {
        ...
        try {
            Lister ls = new Lister(ctx);
            ls.createAndOpenDB();
            mData = ls.executeReader("Select *from MPNC where is_synced IN ('0','0,3')");
            Log.d("000115", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                //Log.d("000115", "ID: " + mData[i][0]);
                Log.d("000115", "member_uid: " + mData[i][1]);
                Log.d("000115", "pregnancy_id: " + mData[i][2]);
                Log.d("000115", "record_data: " + mData[i][3]);
                Log.d("000115", "type: " + mData[i][4]);
              /*  Log.d("000115", "data: " + mData[i][5]);
                Log.d("000115", "added_by: " + mData[i][6]);
                Log.d("000115", "is_synced: " + mData[i][7]);
                Log.d("000115", "added_on: " + mData[i][8]);*/
                ...
                if (mData_name != null) {
                    Log.d("000115", "IF ***********: ");
                    Log.d("000115", "Mother Name: " + mData_name[0][0]);
                    Log.d("000115", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000115", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][8] == null) {
                    ...
                    Log.d("000115", "datetime: " + formatted);
  ...
  /*  @Override
    protected void onResume() {
        ...
        try {
            Lister ls = new Lister(ctx);
            ls.createAndOpenDB();
            mData = ls.executeReader("Select *from MPNC where is_synced = '0'");
            Log.d("000115", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000115", "Child Name: " + mData_name[j][0]);
