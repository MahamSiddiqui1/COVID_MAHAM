...
public class SyncMotherPregnancy_Activity extends AppCompatActivity {

    Context ctx = SyncMotherPregnancy_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000112", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000112", "Shared Err:" + e.getMessage());
        }
      ...
      /*  adt = new Adt_SyncItems(ctx, arrayList);
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000112", "IFFFF 2");
                    } else {
                        Log.d("000112", "ELssssss 2");
                    }
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("pregnancy_id"), arrayList.get(0).get("record_data"), arrayList.get(0).get("lmp"),
                                            arrayList.get(0).get("edd"), arrayList.get(0).get("metadata"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000112", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000112", "IFFFF OFFLINE");
                    } else {
                        Log.d("000112", "ELssssss OFFLINE");
                    }

                    //  Toast.makeText(ctx, "برائے مہربانی انٹرنیٹ کنکشن چیک کریں", Toast.LENGTH_SHORT).show();
                    sendSMSMethod_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("pregnancy_id"), arrayList.get(0).get("record_data"), arrayList.get(0).get("lmp"),
                            arrayList.get(0).get("edd"), arrayList.get(0).get("metadata"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000112", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                               ...
                               /* sendPostRequest(mData[position][1], mData[position][2], mData[position][3], mData[position][4], mData[position][5]
                                        , mData[position][6], mData[position][8], mData[position][10]);*/
                                sendPostRequest(arrayList.get(position).get("member_uid"), arrayList.get(position).get("pregnancy_id"), arrayList.get(position).get("record_data"), arrayList.get(position).get("lmp"),
                                        arrayList.get(position).get("edd"), arrayList.get(position).get("metadata"), arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
                        ...
                        Log.d("000112", "Catach Err: " + e.getMessage());
                    }
                    ...
                    /*sendSMSMethod(mData[position][1], mData[position][2], mData[position][3], mData[position][4], mData[position][5]
                            , mData[position][6], mData[position][8], mData[position][10]);*/
                    sendSMSMethod(arrayList.get(position).get("member_uid"), arrayList.get(position).get("pregnancy_id"), arrayList.get(position).get("record_data"), arrayList.get(position).get("lmp"),
                            arrayList.get(position).get("edd"), arrayList.get(position).get("metadata"), arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000112", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String pregnancy_id, final String record_data, final String lmp, final String edd,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000112", "Response:    " + response);
                       ...
                       ls.createAndOpenDB();
                        ...
                        String update_record = "UPDATE MPREGNANCY SET " +
                                ...
                                "WHERE member_uid = '" + member_uid + "'AND pregnancy_id= '" + pregnancy_id + "'AND added_on= '" + added_on + "'";
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000112", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000112", "onErrorResponse String: " + string);
                Log.d("000112", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000112", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000112", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String member_uid, final String pregnancy_id, final String record_data, final String lmp, final String edd,
                                         final String data, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String member_uid, final String pregnancy_id, final String record_data, final String lmp, final String edd,
                              final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            jobj.put("pregnancy_id", pregnancy_id);
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "MPREGNANCY" + "|" + toencode_sms;
            ...
            switch (simState) {
                ...
                case TelephonyManager.SIM_STATE_READY:
                    ...
                    PendingIntent piSent = PendingIntent.getBroadcast(SyncMotherPregnancy_Activity.this, 0, new Intent("SMS_SENT"), 0);
                    PendingIntent piDelivered = PendingIntent.getBroadcast(SyncMotherPregnancy_Activity.this, 0, new Intent("SMS_DELIVERED"), 0);
    ...
    public void sendSMSMethod_Overall(final String member_uid, final String pregnancy_id, final String record_data, final String lmp, final String edd,
                                      final String data, final String added_by, final String added_on) {
    ...
    private void read_data() {
        ...
        try {
            Lister ls = new Lister(ctx);
            ls.createAndOpenDB();
            mData = ls.executeReader("Select *from MPREGNANCY where is_synced IN ('0','0,3')");
            Log.d("000112", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
              ...
              //  Log.d("000112", "ID: " + mData[i][0]);
                Log.d("000112", "member_uid: " + mData[i][1]);
                Log.d("000112", "pregnancy_id: " + mData[i][2]);
                Log.d("000112", "record_data: " + mData[i][3]);
                Log.d("000112", "lmp: " + mData[i][4]);
                Log.d("000112", "edd: " + mData[i][5]);
                /*Log.d("000112", "metadata: " + mData[i][6]);
                Log.d("000112", "status: " + mData[i][7]);
                Log.d("000112", "added_by: " + mData[i][8]);
                Log.d("000112", "is_synced: " + mData[i][9]);
                Log.d("000112", "added_on: " + mData[i][10]);*/

                map.put("Id", "" + mData[i][0]);
                map.put("member_uid", "" + mData[i][1]);
                map.put("pregnancy_id", "" + mData[i][2]);
                map.put("record_data", "" + mData[i][3]);
                map.put("lmp", "" + mData[i][4]);
                map.put("edd", "" + mData[i][5]);
                map.put("metadata", "" + mData[i][6]);
                map.put("status", "" + mData[i][7]);
                map.put("added_by", "" + mData[i][8]);
                map.put("is_synced", "" + mData[i][9]);
                map.put("added_on", "" + mData[i][10]);
                ...
                if (mData_name != null) {
                    Log.d("000112", "IF ***********: ");
                    Log.d("000112", "Mother Name: " + mData_name[0][0]);
                    Log.d("000112", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000112", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][10] == null) {
                    ...
                    Date date = new Date(Long.parseLong(mData[i][10]));
                    SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy hh:mm:ss");
                    String formatted = format.format(date);
                    Log.d("000112", "datetime: " + formatted);
   ...
   /* @Override
    protected void onResume() {
        ...
        try {
            Lister ls = new Lister(ctx);
            ls.createAndOpenDB();
            mData = ls.executeReader("Select *from MPREGNANCY where is_synced = '0'");
            Log.d("000112", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000112", "Child Name: " + mData_name[j][0]);
