...
public class SyncReferral_Activity extends AppCompatActivity {

    Context ctx = SyncReferral_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000107", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000107", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000107", "IFFFF 2");
                    } else {
                        Log.d("000107", "ELssssss 2");
                    }
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000107", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000107", "IFFFF OFFLINE");
                    } else {
                        Log.d("000107", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000107", " mLastClickTime: " + mLastClickTime);
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequest(arrayList.get(0).get("member_uid"), arrayList.get(0).get("record_data"), arrayList.get(0).get("data"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                        ...
                        Log.d("000107", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000107", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000107", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.d("000107", "onErrorResponse: " + error.getMessage());
                String string = new String(error.networkResponse.data);
                Log.d("000107", "onErrorResponse String: " + string);
                Log.d("000107", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains("Duplicate entry"))
                {
                    Log.d("000107", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000107", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String member_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "REFERRAL" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from REFERAL where is_synced IN ('0','0,3')");
            Log.d("000107", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
               ...
               // Log.d("000107", "ID: " + mData[i][0]);
                Log.d("000107", "member_uid: " + mData[i][1]);
                Log.d("000107", "record_data: " + mData[i][2]);
               /* Log.d("000107", "data: " + mData[i][3]);
                Log.d("000107", "added_by: " + mData[i][4]);
                Log.d("000107", "is_synced: " + mData[i][5]);
                Log.d("000107", "added_on: " + mData[i][6]);*/
                ...
                if (mData_name != null) {
                    Log.d("000107", "IF ***********: ");
                    Log.d("000107", "Name: " + mData_name[0][0]);
                    Log.d("000107", "Table Type: " + mData_name[0][1]);
                    map.put("name", "" + mData_name[0][0]);

                } else {
                    Log.d("000107", "ELSEEEEEE +++++++++++++: ");
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000107", "datetime: " + formatted);
    ...
    protected void onResume() {
        ...
        try {
           ...
           ls.createAndOpenDB();
            ...
            mData = ls.executeReader("Select *from REFERAL where is_synced = '0'");
            Log.d("000107", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000107", "Child Name: " + mData_name[j][0]);
