...
public class SyncVideo_Activity extends AppCompatActivity {

    Context ctx = SyncVideo_Activity.this;
    ListView lv;
    ...
    public void sendSMSMethod(final String video_name, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HayatPK" + "|" + uuid + "|" + "VIDEOS" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            for (int i = 0; i < mData.length; i++) {
              ...
              //  Log.d("000333", "ID: " + mData[i][0]);
                Log.d("000333", "video_name: " + mData[i][1]);
                Log.d("000333", "record_data: " + mData[i][2]);
               /* Log.d("000333", "data: " + mData[i][3]);
                Log.d("000333", "added_by: " + mData[i][4]);
                Log.d("000333", "is_synced: " + mData[i][5]);
                Log.d("000333", "added_on: " + mData[i][6]);*/
            ...
            for (int i = 0; i < mData.length; i++) {
              ...
              /*  String mData_name[][] = ls.executeReader("Select username from USERS where uid = '" + mData[i][4] + "'");
                for (int j = 0; j < mData_name.length; j++) {
                        ...
                        {
                            Log.d("000333", "USER Name NULL: " );
                            map.put("name", "" + "none");
                        }
                        else{
                            Log.d("000333", "USER Name: " + mData_name[j][0]);
