...
public class LocationHelper {
    ...
    private Runnable showTime = new Runnable() {
        ...
        public void run() {
            ...
            if (bestLocation == null && gps_enabled && stop != true) {
                Log.d("000321", "BestLocation not ready, continue wait");
                ...
                if (stop == false && !needToStop()) {
                    Log.d("000321",  "Connected " + sat_count + " sattelites. continue waiting..");
                    handler.postDelayed(this, iteration_timeout_step);
                } else {

                    Log.d("000321",  "#########################################");
                    Log.d("000321",  "BestLocation finded return result to main. sat_count=" + sat_count);
                    Log.d("000321",  "#########################################");
            ...
            if (event == GpsStatus.GPS_EVENT_SATELLITE_STATUS) {
                try {
                    ...
                    while (satI.hasNext()) {
                        ...
                        Log.d("000321", "Satellite: snr=" + satellite.getSnr() + ", elevation=" + satellite.getElevation());
                        sat_count++;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                Log.d("000321",  "#### sat_count = " + sat_count);
    ...
    public static Location getLocation(Context context) {
        ...
        try {
            ...
            Log.d("000321", "strLocationProvider=" + strLocationProvider);
