package com.akdndhrc.covid_module.VAC_App.ChildHifazitiTeekeyRecordActivities;
...
public class Child_HifazitiTeekeyVaccineKoAnjamDy_Activity extends AppCompatActivity {

    Context ctx = Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.class));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE) {
            ...
            try {
                ...
                thumbnail = MediaStore.Images.Media.getBitmap(getContentResolver(), Uri.fromFile(image_path));
    ...
    private File createImageFile() throws IOException {
        ...
        Log.d("000555", "FilePath:" + image_path);
    ...
    public void insert_db() {
        try {
            ...
            Lister ls = new Lister(Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this);
            ls.createAndOpenDB();
    ...
    private void sendPostRequest(final String member_uid, final String vacine_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        Toast.makeText(Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this, "Data has been saved", Toast.LENGTH_SHORT).show();
                    ...
                    Log.d("000555", " Error: " + e.getMessage());
                    Toast.makeText(Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this, R.string.incorrectDataSent, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this, R.string.checkInternetPrompt, Toast.LENGTH_SHORT).show();
                finish();
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                    try {
                        ...
                        Log.d("000555", "Resp " + a);
                        Toast.makeText(Child_HifazitiTeekeyVaccineKoAnjamDy_Activity.this, "" + a, Toast.LENGTH_SHORT).show();
