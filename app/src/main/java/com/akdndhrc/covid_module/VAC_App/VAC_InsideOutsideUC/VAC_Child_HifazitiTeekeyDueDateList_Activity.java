...
import static com.akdndhrc.covid_module.R.string.vialNotOpenEng;


public class VAC_Child_HifazitiTeekeyDueDateList_Activity extends AppCompatActivity {

    Context ctx = VAC_Child_HifazitiTeekeyDueDateList_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, VAC_Child_HifazitiTeekeyDueDateList_Activity.class));
     ...
     if (child_gender.equalsIgnoreCase("0")) {
        ...
        btn_kahi_aur_sy_karae_ho.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(ctx, VAC_Child_HifazitiTeekeyKahiAurSyLiHoe_Activity.class);
    ...
    public void Dialog_VaccineKoAnjaamDy() {
        ...
        //LineraLayout
        final LinearLayout ll_balance = dialogView.findViewById(R.id.ll_balance);
        final LinearLayout ll_utilized = dialogView.findViewById(R.id.ll_utilized);

      //TextVIew
        final TextView tvBalance = dialogView.findViewById(R.id.tvBalance);
        final TextView tvUtilized = dialogView.findViewById(R.id.tvUtilized);
             ...
             /*   if (mData[index_val][1].equalsIgnoreCase("BCG") || mData[index_val][1].equalsIgnoreCase("OPV-0") || mData[index_val][1].equalsIgnoreCase("OPV-1")
                ...
                if (mData[index_val][1].equalsIgnoreCase("BCG") ||mData[index_val][1].equalsIgnoreCase("Measles-1") || mData[index_val][1].equalsIgnoreCase("Measles-2")) {
                    ...
                    try {
                        ...
                        String[] vacine_split_name = mData[index_val][1].split("-");
                        Log.d("000159", "vacine_split_name: " + vacine_split_name[0]);
                        ...
                        String[][]  mData_VaccineStock = ls.executeReader("SELECT max(added_on),vaccine_name,received,utilized from VACCINE_STOCK where vaccine_name ='" + vacine_split_name[0] + "'");

                        if (mData_VaccineStock[0][0] != null) {

                            ll_balance.setVisibility(View.VISIBLE);
                            ll_utilized.setVisibility(View.VISIBLE);
                            ...
                            total_balancedoses = Integer.parseInt(mData_VaccineStock[0][2]) * Integer.parseInt(mData_VaccineStock[0][3]);


                            String[][] temp_data = ls.executeReader("SELECT count(*) from CVACCINE_VIALS where vaccine_name ='" + mData[index_val][1] + "'");
                            if (Integer.parseInt(temp_data[0][0]) > 0) {
                                ...
                                tvBalance.setText(doubleResult + " vials / " +total_balancedoses + " doses");
                                tvUtilized.setText(utilized_vials + " doses");
                            }
                            else {
                                Toast.makeText(ctx, vialNotOpenEng, Toast.LENGTH_SHORT).show();

                                tvBalance.setText(received_vials + " vials / " +total_balancedoses + " doses");
                                tvUtilized.setText(utilized_vials + " doses");
                            }
                        } else {

                            ll_balance.setVisibility(View.GONE);
                            ll_utilized.setVisibility(View.GONE);

                            Toast.makeText(ctx, R.string.fillVaccStockEng, Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                    ...
                    btn_opened_vial.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(ctx, VAC_Child_HifazitiTeekeyVaccineKoAnjamDy_3_Activity.class);
        ...
        btn_phle_sy_li_hoe_vaccine_uc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Lister ls = new Lister(VAC_Child_HifazitiTeekeyDueDateList_Activity.this);
                    ls.createAndOpenDB();
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            dialog.dismiss();
                            Intent intent = new Intent(ctx, VAC_Child_HifazitiTeekeyDueDateList_Activity.class);
                            intent.putExtra("u_id", child_uid);
                            intent.putExtra("child_name", child_name);
                            intent.putExtra("child_gender", child_gender);
                            startActivity(intent);
    ...
    private void sendPostRequest(final String member_uid, final String vacine_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000159", "error    " + error.getMessage());
