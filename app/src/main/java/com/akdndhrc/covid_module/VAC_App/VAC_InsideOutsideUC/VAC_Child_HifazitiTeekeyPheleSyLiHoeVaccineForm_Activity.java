...
public class VAC_Child_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity extends AppCompatActivity {

    Context ctx = VAC_Child_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, VAC_Child_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.class));
    ...
    public void onBackPressed() {
        ...
        // startActivity(new Intent(ctx, VAC_Child_HifazitiTeekeyRecordList_Activity.class));
    }
}
