...
public class VAC_Mother_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity extends AppCompatActivity {

    Context ctx = VAC_Mother_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, VAC_Mother_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.class));
        ...
        btn_jamaa_kre.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Lister ls = new Lister(VAC_Mother_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.this);
                    ls.createAndOpenDB();
    ...
    public void ShowTareekhDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(VAC_Mother_HifazitiTeekeyPheleSyLiHoeVaccineForm_Activity.this, R.style.DatePickerDialog,
