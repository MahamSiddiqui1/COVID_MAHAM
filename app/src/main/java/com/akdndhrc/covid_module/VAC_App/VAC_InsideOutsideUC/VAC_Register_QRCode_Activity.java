...
public class VAC_Register_QRCode_Activity extends AppCompatActivity implements ZXingScannerView.ResultHandler {

    Context ctx = VAC_Register_QRCode_Activity.this;

    private ZXingScannerView mScannerView;
    ImageView iv_navigation_drawer, iv_home;
    String class_id;
    public static String switch_qr_code_values_vac = "0";
    ...
    public void handleResult(final Result rawResult) {
        ...
        android.app.AlertDialog.Builder dialogBuilder = new android.app.AlertDialog.Builder(VAC_Register_QRCode_Activity.this);
