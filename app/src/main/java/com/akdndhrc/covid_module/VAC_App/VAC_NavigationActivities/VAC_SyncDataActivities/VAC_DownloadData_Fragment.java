...
public class VAC_DownloadData_Fragment extends Fragment {
    ...
    public VAC_DownloadData_Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(getContext(), VAC_DownloadData_Fragment.class));
        ...
        iv_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(getContext(), HomePageVacinator_Activity.class);
                            ...
                            try {
                                ...
                                if (Integer.parseInt(read_MVaccination_data[0][0]) < jobj.length()) {
                                    ...
                                    for (i = 0; i < jobj.length(); i++) {
                                        ...
                                        query_MVaccination_data = "insert or ignore into MVACINE (member_uid, vaccine_id, record_data, type, due_date,vaccinated_on, image_location, metadata, added_by,is_synced,added_on)" +
                                                "values" +
                                                "(" +
                                                "'" + jobj.getJSONObject(i).getString("member_id") + "'," +
                                                "'" + jobj.getJSONObject(i).getString("vaccine_id") + "'," +
