...
public class VAC_SyncChildHifazitiTeekey_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncChildHifazitiTeekey_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000203", "Shared Err:" + e.getMessage());
        }
       ...
       /* adt = new Adt_SyncItems(ctx, arrayList);
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    /*Log.d("000203", "0: " +arrayList.get(0).get("member_uid") );
                                    Log.d("000203", "01: " +arrayList.get(0).get("vaccine_id") );
                                    Log.d("000203", "02: " +arrayList.get(0).get("record_data") );
                                    Log.d("000203", "03: " +arrayList.get(0).get("metadata") );
                                    Log.d("000203", "04: " +arrayList.get(0).get("added_by") );
                                    Log.d("000203", "05: " +arrayList.get(0).get("added_on") );*/


                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("vaccine_id"), arrayList.get(0).get("record_data"),
                                            arrayList.get(0).get("metadata"), arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                                } else {
                                    alertDialog.dismiss();
                                    onBackPressed();
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000203", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000203", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000203", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000203", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String vacine_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000203", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000203", "onErrorResponse: " + error.getMessage());
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", mData[Integer.parseInt(pos_value)][4]);
                params.put("record_data", record_data);
                params.put("vaccinated_on", mData[Integer.parseInt(pos_value)][6]);
                params.put("image_location", mData[Integer.parseInt(pos_value)][7]);
                params.put("metadata", data);
                params.put("added_by", added_by);
                params.put("added_on", added_on);


                Log.d("000203", "mParam " + params);
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                       ...
                       ls.createAndOpenDB();
                        ...
                        String update_record = "UPDATE CVACCINATION SET " +
                                "is_synced='" + String.valueOf(1) + "' " +
                                "WHERE member_uid = '" + member_uid + "'AND vaccine_id= '" + vacine_uid + "' AND added_on= '" + added_on + "'";
    ...
    public void sendSMSMethod(final String member_uid, final String vacine_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HAYATPK" + "|" + uuid + "|" + "VAC_CVACCINE" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            Log.d("000203", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                Log.d("000203", "ID: " + mData[i][0]);
                Log.d("000203", "member_uid: " + mData[i][1]);
                Log.d("000203", "vaccine_id: " + mData[i][2]);
                Log.d("000203", "record_data: " + mData[i][3]);
             /*   Log.d("000203", "type: " + mData[i][4]);
                Log.d("000203", "due_date: " + mData[i][5]);
                Log.d("000203", "vaccinated_on: " + mData[i][6]);
                Log.d("000203", "image_location: " + mData[i][7]);
                Log.d("000203", "metadata: " + mData[i][8]);
                Log.d("000203", "added_by: " + mData[i][9]);
                Log.d("000203", "is_synced: " + mData[i][10]);
                Log.d("000203", "added_on: " + mData[i][11]);*/
                ...
                for (int j = 0; j < mData_name.length; j++) {
                    ...
                    Log.d("000203", "Child Name: " + mData_name[j][0]);
                ...
                if (mData[i][11] == null) {
                    ...
                    Log.d("000203", "datetime: " + formatted);
