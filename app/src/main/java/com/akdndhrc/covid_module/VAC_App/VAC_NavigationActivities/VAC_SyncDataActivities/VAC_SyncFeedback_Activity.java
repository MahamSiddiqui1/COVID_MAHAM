...
public class VAC_SyncFeedback_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncFeedback_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000205", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000205", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000205", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000205", "IFFFF OFFLINE");
                    } else {
                        Log.d("000205", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000205", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        Log.d("000205", "Catach Err: " + e.getMessage());
                    }
    ...
    protected void onResume() {
        ...
        {
            Log.d("000205", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final Integer feedback, final String data, final String added_by, final String added_on) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000205", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000205", "onErrorResponse: " + error.getMessage());

                String string = new String(error.networkResponse.data);
                Log.d("000205", "onErrorResponse String: " + string);
                Log.d("000205", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000205", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000205", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final Integer feedback,  final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HayatPK" + "|" + uuid + "|" + "VAC_FEEDBACK" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            Log.d("000205", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                Log.d("000205", "rating: " + mData[i][0]);
                Log.d("000205", "record_data: " + mData[i][1]);
               /* Log.d("000205", "data: " + mData[i][2]);
                Log.d("000205", "added_by: " + mData[i][3]);
                Log.d("000205", "is_synced: " + mData[i][4]);
                Log.d("000205", "added_on: " + mData[i][5]);*/
                ...
                if (mData[i][5] == null) {
                    ...
                    Log.d("000205", "datetime: " + formatted);
...
//                    {
//                        Log.d("000205", "USER Name NULL: " );
//                        map.put("name", "" + "none");
//                    }
//                    else{
//                        Log.d("000205", "USER Name: " + mData_name[j][0]);
