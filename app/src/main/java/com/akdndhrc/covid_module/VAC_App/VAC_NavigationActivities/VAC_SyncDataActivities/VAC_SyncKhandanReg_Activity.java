...
public class VAC_SyncKhandanReg_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncKhandanReg_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncFamReg);
        ...
        try {
            ...
            Log.d("000201", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000201", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000201", "IFFFF 2");
                    } else {
                        Log.d("000201", "ELssssss 2");
                    }
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_overall(arrayList.get(0).get("manual_id"), arrayList.get(0).get("uid"), arrayList.get(0).get("province_id"), arrayList.get(0).get("district_id"),
                                            arrayList.get(0).get("subdistrict_id"), arrayList.get(0).get("uc_id"), arrayList.get(0).get("village_id"), arrayList.get(0).get("family_head_name"), arrayList.get(0).get("family_address"),
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000201", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000201", "IFFFF OFFLINE");
                    } else {
                        Log.d("000201", "ELssssss OFFLINE");
                    }
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000201", " mLastClickTime: " + mLastClickTime);
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //Log.d("000201", "Name: " + arrayListKhandan.get(position).family_head_name);
                                pos_value = position;
               ...
               /* sendPostRequest(mData[position][1], mData[position][2], mData[position][3], mData[position][4], mData[position][5], mData[position][6], mData[position][7], mData[position][8], mData[position][9],
                        mData[position][10], mData[position][11], mData[position][12],  mData[position][14]);*/
                                ...
                                sendPostRequest(arrayList.get(position).get("manual_id"), arrayList.get(position).get("uid"), arrayList.get(position).get("province_id"), arrayList.get(position).get("district_id"),
                        ...
                        Log.d("000201", "Catach Err: " + e.getMessage());
                    }
                    ...
                    pos_value = position;
                    Log.d("000951", "POSITION: " + pos_value);
    ...
    protected void onResume() {
        ...
        {
            Log.d("000201", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String manual_id, final String uid, final String province_id, final String district_id,
        ...
        //String url = "https://development.api.teekoplus.akdndhrc.org/sync/save/family/";

        Log.d("000201", "mURL " + url);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        Log.d("000201", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000201", "onErrorResponse: " + error.getMessage());
                
                String string = new String(error.networkResponse.data);
                Log.d("000201", "onErrorResponse String: " + string);
                Log.d("000201", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000201", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000201", "Duplicate Entry NOT: ");
    ...
    public void sendSMSMethod(final String manual_id, final String uid, final String province_id, final String district_id,
        ...
        try {
            ...
            final String sms_data = "HayatPK" + "|" + uuid + "|" + "VAC_KHANDAN" + "|" + toencode_sms;
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                // Toast.makeText(ctx.this, R.string.SMSsendingFail, Toast.LENGTH_SHORT).show();
    ...
    private void read_data() {
        ...
        try {
            ...
            Log.d("000201", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                Log.d("000201", "ID: " + mData[i][0]);
                Log.d("000201", "manual_id: " + mData[i][1]);
                Log.d("000201", "uid: " + mData[i][2]);
               /* Log.d("000201", "province_id: " + mData[i][3]);
                Log.d("000201", "district_id: " + mData[i][4]);
                Log.d("000201", "subdistrict_id: " + mData[i][5]);
                Log.d("000201", "uc_id: " + mData[i][6]);
                Log.d("000201", "village_id: " + mData[i][7]);*/
                Log.d("000201", "family_head_name: " + mData[i][8]);
               /* Log.d("000201", "family_address: " + mData[i][9]);
                Log.d("000201", "water_source: " + mData[i][10]);
                Log.d("000201", "toilet_facility: " + mData[i][11]);
                Log.d("000201", "added_by: " + mData[i][12]);
                Log.d("000201", "is_synced: " + mData[i][13]);
                Log.d("000201", "added_on: " + mData[i][14]);*/
                ...
                map.put("family_head_name", "" + mData[i][8]);
                ...
                if (mData[i][14] == null) {
                    ...
                    Log.d("000201", "datetime: " + formatted);
