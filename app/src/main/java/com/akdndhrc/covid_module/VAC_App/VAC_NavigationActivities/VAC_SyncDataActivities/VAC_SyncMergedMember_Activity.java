...
public class VAC_SyncMergedMember_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncMergedMember_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("000207", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000207", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid_1"), arrayList.get(0).get("member_uid_2"), arrayList.get(0).get("metadata"),  arrayList.get(0).get("record_data"),
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("0002073", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000207", "IFFFF OFFLINE");
                    } else {
                        Log.d("000207", "ELssssss OFFLINE");
                    }
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendSMSMethod_overall(arrayList.get(0).get("member_uid_1"), arrayList.get(0).get("member_uid_2"), arrayList.get(0).get("metadata"),  arrayList.get(0).get("record_data"),
                                    arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000207", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequest(arrayList.get(position).get("member_uid_1"), arrayList.get(position).get("member_uid_2"), arrayList.get(position).get("metadata"),  arrayList.get(position).get("record_data"),
                        ...
                        Log.d("0002073", "Catach Err: " + e.getMessage());
                    }
                    ...
                    pos_value = String.valueOf(position);
                    sendSMSMethod(arrayList.get(position).get("member_uid_1"), arrayList.get(position).get("member_uid_2"), arrayList.get(position).get("metadata"),  arrayList.get(position).get("record_data"),
                            arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000207", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_id_1, final String member_id_2, final String metadata , final String record_data ,final String added_by,  final String added_on) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("0002073", "Response:    " + response);
                    ...
                    alertDialog.dismiss();
                    Log.d("0002073", "Err: " + e.getMessage());
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000207", "onErrorResponse: " + error.getMessage());

                String string = new String(error.networkResponse.data);
                Log.d("000207", "onErrorResponse String: " + string);
                Log.d("000207", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains("Duplicate entry"))
                {
                    Log.d("000207", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000207", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String member_id_1, final String member_id_2, final String metadata , final String record_data ,final String added_by,  final String added_on){
    ...
    public void sendSMSMethod(final String member_id_1, final String member_id_2, final String metadata , final String record_data ,final String added_by,  final String added_on) {

        try {

            JSONObject jobj = new JSONObject();
            jobj.put("member_id_1", member_id_1);
            jobj.put("member_id_2", member_id_2);
    ...
    public void sendSMSMethod_overall(final String member_id_1, final String member_id_2, final String metadata , final String record_data ,final String added_by,  final String added_on)  {
    ...
    private void read_data() {
        ...
        try {
            ...
            //mData = ls.executeReader("Select *from MEMBER_MERGERD where is_synced = '0'");
            mData = ls.executeReader("Select t0.* , t1.full_name from MEMBER_MERGERD t0" +
                    " INNER JOIN MEMBER t1 ON t0.member_uid_2 = t1.uid" +
                    " where t0. is_synced IN ('0','0,3')");
//                    " where t0. is_synced = '0'");
            Log.d("0002073", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                Log.d("0002073", "member_uid_1: " + mData[i][0]);
                Log.d("0002073", "member_uid_2: " + mData[i][1]);
                Log.d("0002073", "full_name: " + mData[i][7]);

                map.put("Id", "" + String.valueOf(i + 1));
                map.put("member_uid_1", "" + mData[i][0]);
                map.put("member_uid_2", "" + mData[i][1]);
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("0002073", "datetime: " + formatted);
