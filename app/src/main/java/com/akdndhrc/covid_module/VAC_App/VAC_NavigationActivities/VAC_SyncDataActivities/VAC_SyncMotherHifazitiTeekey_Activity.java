...
public class VAC_SyncMotherHifazitiTeekey_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncMotherHifazitiTeekey_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("سینک ماں کے حفاظتی ٹیکے");
        ...
        try {
            ...
            Log.d("000206", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000206", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000206", "IFFFF 2");
                    } else {
                        Log.d("000206", "ELssssss 2");
                    }
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("vaccine_id"), arrayList.get(0).get("vaccinated_on"), arrayList.get(0).get("data"),
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000206", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000206", "IFFFF OFFLINE");
                    } else {
                        Log.d("000206", "ELssssss OFFLINE");
                    }
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            sendSMSMethod_Overall(arrayList.get(0).get("member_uid"), arrayList.get(0).get("vaccine_id"), arrayList.get(0).get("vaccinated_on"), arrayList.get(0).get("data"),
                                    arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000206", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //sendPostRequest(mData[position][1], mData[position][7], mData[position][9], mData[position][3], mData[position][4], mData[position][6]);
                                sendPostRequest(arrayList.get(position).get("member_uid"), arrayList.get(position).get("vaccine_id"), arrayList.get(position).get("vaccinated_on"), arrayList.get(position).get("data"),
                                        arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
                        ...
                        Log.d("000206", "Catach Err: " + e.getMessage());
                    }
                    ...
                    pos_value = String.valueOf(position);
                    sendSMSMethod(arrayList.get(position).get("member_uid"), arrayList.get(position).get("vaccine_id"), arrayList.get(position).get("vaccinated_on"), arrayList.get(position).get("data"),
                            arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000206", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String member_uid, final String vacine_uid, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        ...
                        Log.d("000206", "response:  " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000206", "onErrorResponse: " + error.getMessage());

                String string = new String(error.networkResponse.data);
                Log.d("000206", "onErrorResponse String: " + string);
                Log.d("000206", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains("Duplicate entry"))
                {
                    Log.d("000206", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000206", "Duplicate Entry NOT: ");
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("type", mData[Integer.parseInt(pos_value)][8]);
                params.put("record_data", record_data);
                params.put("vaccinated_on", mData[Integer.parseInt(pos_value)][9]);
                params.put("image_location", mData[Integer.parseInt(pos_value)][10]);
                params.put("metadata", data);
                params.put("added_by", added_by);
                params.put("added_on", added_on);


                Log.d("000206", "mParam " + params);
    ...
    private void sendPostRequest_Overall(final String member_uid, final String vacine_uid, final String record_data,
                                         final String data, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String member_uid, final String vacine_uid, final String record_data, final String data, final String added_by, final String added_on) {
        ...
        try {
            ...
            final String sms_data = "HayatPK" + "|" + uuid + "|" + "VAC_MVACCINE" + "|" + toencode_sms;
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from MVACINE where  is_synced IN ('0','0,3')");
            //mData = ls.executeReader("Select *from MVACINE where is_synced = '0'");

            Log.d("000206", "Data: " + mData.length);

            HashMap<String, String> map;
            for (int i = 0; i < mData.length; i++) {

                map = new HashMap<>();
                //Log.d("000206", "Id: " + mData[i][0]);
                Log.d("000206", "member_uid: "  + mData[i][1]);
                Log.d("000206", "record_data: "+ mData[i][2]);
                /*Log.d("000206", "data:" + mData[i][3]);
                Log.d("000206", "added_by:"+ mData[i][4]);
                Log.d("000206", "is_synced:" + mData[i][5]);
                Log.d("000206", "added_on:" + mData[i][6]);*/
                Log.d("000206", "vaccine_id:" + mData[i][7]);
                Log.d("000206", "type:"+ mData[i][8]);
              /*  Log.d("000206", "vaccinated_on:"+ mData[i][9]);
                Log.d("000206", "image_location:" + mData[i][10]);*/
                ...
                map.put("vaccine_id", "" + mData[i][7]);
                map.put("type", "" + mData[i][8]);
                map.put("vaccinated_on", "" + mData[i][9]);
                map.put("image_location", "" + mData[i][10]);

                String mData_name[][] = ls.executeReader("Select full_name from MEMBER where uid = '" + mData[i][1] + "'");
                for (int j = 0; j < mData_name.length; j++) {

                    Log.d("000206", "Mother Name: " + mData_name[j][0]);
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000206", "datetime: " + formatted);
