...
public class VAC_SyncVideo_Activity extends AppCompatActivity {

    Context ctx = VAC_SyncVideo_Activity.this;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.syncVideos);
        ...
        try {
            ...
            Log.d("000204", "USER UID: " + shared_sms_number);

        } catch (Exception e) {
            Log.d("000204", "Shared Err:" + e.getMessage());
        }
            ...
            public void onClick(final View v) {
                ...
                if (isConnectingToInternet()) {
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000204", "IFFFF 2");
                    } else {
                        Log.d("000204", "ELssssss 2");
                    }
                        ...
                        public void run() {
                            ...
                            try {
                                if (arrayList.size() > 0) {
                                    ...
                                    sendPostRequest_Overall(arrayList.get(0).get("name"), arrayList.get(0).get("record_data"), arrayList.get(0).get("data"),
                                ...
                                e.printStackTrace();
                                alertDialog.dismiss();
                                Log.d("000204", "Error:" + e.getMessage());
                            }
                        }
                    }, 1000);
                    ...
                    if (temp.equalsIgnoreCase("0")) {
                        ...
                        Log.d("000204", "IFFFF OFFLINE");
                    } else {
                        Log.d("000204", "ELssssss OFFLINE");
                    }
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            sendSMSMethod_overall(arrayList.get(0).get("name"), arrayList.get(0).get("record_data"), arrayList.get(0).get("data"),
                                    arrayList.get(0).get("added_by"), arrayList.get(0).get("added_on"));
                        }
                    }, 1500);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Log.d("000204", " mLastClickTime: " + mLastClickTime);
                ...
                if (isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                sendPostRequest(arrayList.get(position).get("name"), arrayList.get(position).get("record_data"), arrayList.get(position).get("data"),
                        ...
                        Log.d("000204", "Catach Err: " + e.getMessage());
                    }
                    ...
                    sendSMSMethod(arrayList.get(position).get("name"), arrayList.get(position).get("record_data"), arrayList.get(position).get("data"),
                            arrayList.get(position).get("added_by"), arrayList.get(position).get("added_on"));
    ...
    protected void onResume() {
        ...
        {
            Log.d("000204", "onResume Error: " +e.getMessage());
    ...
    private void sendPostRequest(final String video_name, final String record_data,
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jobj.getBoolean("success")) {
                        Log.d("000204", "Response:    " + response);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("000204", "onErrorResponse: " + error.getMessage());

                String string = new String(error.networkResponse.data);
                Log.d("000204", "onErrorResponse String: " + string);
                Log.d("000204", "onErrorResponse Status: " + error.networkResponse.statusCode);

                if (string.contains((getString(R.string.duplicateEntry))))
                {
                    Log.d("000204", "Duplicate Entry YES !!!!!!!!: ");
                    ...
                    alertDialog.dismiss();
                    Log.d("000204", "Duplicate Entry NOT: ");
    ...
    private void sendPostRequest_Overall(final String video_name, final String record_data,
                                 final String data, final String added_by, final String added_on) {
    ...
    public void sendSMSMethod(final String video_name, final String record_data, final String data, final String added_by, final String added_on) {

        try {

            JSONObject jobj = new JSONObject();
            jobj.put("video_name", video_name);
    ...
    public void sendSMSMethod_overall(final String video_name, final String record_data, final String data, final String added_by, final String added_on)  {
    ...
    private void read_data() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from VIDEOS where  is_synced IN ('0','0,3')");
            Log.d("000204", "Data: " + mData.length);
            ...
            for (int i = 0; i < mData.length; i++) {
                ...
                //Log.d("000204", "ID: " + mData[i][0]);
                Log.d("000204", "video_name: " + mData[i][1]);
                Log.d("000204", "record_data: " + mData[i][2]);
                /*Log.d("000204", "data: " + mData[i][3]);
                Log.d("000204", "added_by: " + mData[i][4]);
                Log.d("000204", "is_synced: " + mData[i][5]);
                Log.d("000204", "added_on: " + mData[i][6]);*/

                map.put("Id", "" + mData[i][0]);
                map.put("name", "" + mData[i][1]);
              ...
              /*  String mData_name[][] = ls.executeReader("Select username from USERS where uid = '" + mData[i][4] + "'");
                for (int j = 0; j < mData_name.length; j++) {

                        if (mData_name[j][0] == null)
                        {
                            Log.d("000204", "USER Name NULL: " );
                            map.put("name", "" + "none");
                        }
                        else{
                            Log.d("000204", "USER Name: " + mData_name[j][0]);
                ...
                if (mData[i][6] == null) {
                    ...
                    Log.d("000204", "datetime: " + formatted);
...
/*    @Override
    protected void onResume() {
        ...
        try {
            ...
            mData = ls.executeReader("Select *from VIDEOS where is_synced = '0'");
            Log.d("000204", "Data: " + mData.length);
