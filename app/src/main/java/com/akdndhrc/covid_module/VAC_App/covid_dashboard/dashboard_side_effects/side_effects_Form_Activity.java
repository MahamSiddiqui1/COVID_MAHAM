            ...
            public void onClick(View v) {
              ...
              /*  if (et_tareekh_visit.getText().toString().length() < 1) {
                ...
                try {
                    ...
                    jobj.put("value", "" + et_value.getText().toString());
                   // jobj.put("plan", "" + String.valueOf(sp_naya_sabiqa.getSelectedItemPosition() - 1));
                     jobj.put("fever", "" + String.valueOf(sp_fever.getSelectedItemPosition() - 1));
                    jobj.put("shortness_of_breath", "" + String.valueOf(sp_breath.getSelectedItemPosition() - 1));
                    jobj.put("rash", "" + String.valueOf(sp_rash.getSelectedItemPosition() - 1));
                    jobj.put("cough", "" + String.valueOf(sp_cough.getSelectedItemPosition() - 1));
                    jobj.put("loss of taste", "" + String.valueOf(sp_taste.getSelectedItemPosition() - 1));
                    jobj.put("loss of smell", "" + String.valueOf(sp_smell.getSelectedItemPosition() - 1));
                    jobj.put("diarrhea", "" + String.valueOf(sp_dia.getSelectedItemPosition() - 1));
