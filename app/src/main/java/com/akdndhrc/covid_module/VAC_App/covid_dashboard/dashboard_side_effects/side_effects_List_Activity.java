...
public class side_effects_List_Activity extends AppCompatActivity {
    ...
    Context ctx = side_effects_List_Activity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, side_effects_List_Activity.class));
