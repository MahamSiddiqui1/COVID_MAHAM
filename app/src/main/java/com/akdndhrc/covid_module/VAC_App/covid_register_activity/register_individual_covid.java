...
public class register_individual_covid extends AppCompatActivity {

    Context ctx = register_individual_covid.this;
    String uuid;
    ...
    String monthf2, dayf2, yearf2 = "null", TodayDate, union_council, khandan_uuid,peenay_kai_paani_ka_zarya, latrine_system, abc;
    ...
    public static String var_regtemp_abovetwo="null";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vac_above_two);

        Thread.setDefaultUncaughtExceptionHandler(new DefaultExceptionHandler(this, register_individual_covid.class));
...
*/
    ...
    public void Child_Register(View v) {
        ...
        try {
            ...
            Lister ls = new Lister(register_individual_covid.this);
           ls.createAndOpenDB();
          ...
          //  jobj.put("husband_name", "" + et_shohar_ka_naam.getText().toString());
           // jobj.put("husband_cnic_number", "" + et_shohar_ka_cnic_number.getText().toString());
            //jobj.put("husband_mobile_number", "" + et_shohar_ka_mobile_number.getText().toString());
           ...
           // jobj.put("age", "" + age);
            ...
            String ans1 = "insert into MEMBER (manual_id, uid, khandan_id, full_name, nicnumber, phone_number, gender, age, dob, bio_code, qr_code, added_by, data,is_synced,added_on)" +
                    ...
                    "'" + et_walid_ka_mobile_number.getText().toString() + "'," +
            ...
            if (res.toString().equalsIgnoreCase("true"))
            {
                ...
                if (Utils.haveNetworkConnection(ctx) > 0) {
                    ...
                    sendPostRequest(uuid, uuid, khandan_uuid, et_bachey_ka_naam.getText().toString(), et_walid_ka_shanakti_card_number.getText().toString(),
                            et_walid_ka_mobile_number.getText().toString(), String.valueOf(sp_jins.getSelectedItemPosition() - 1), String.valueOf(age), et_tareekh_pedaish.getText().toString(),
...
//        String url = "https://development.api.teekoplus.akdndhrc.org/sync-adapter";
    ...
    public void ShowDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(register_individual_covid.this, R.style.DatePickerDialog,
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(register_individual_covid.this, sp_union_council, tehsils);
                ...
                try {
                   ...
                   ls.createAndOpenDB();
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(register_individual_covid.this, sp_gaon, tehsils);
                ...
                try {
                   ...
                   ls.createAndOpenDB();
                    ...
                    if (tehsils == null) {
                        ...
                        Utils.setSpinnerTehsel(register_individual_covid.this, sp_tahseel, tehsils);
